...
import { Product } from "./ProductsModel.js"; // adjust path as needed
...
> {
  ...
  declare status: "draft" | "pending" | "completed" | "canceled";
...
Order.init(
  {
    ...
    status: {
      type: DataTypes.ENUM("draft", "pending", "completed", "canceled"),
      allowNull: false,
      defaultValue: "draft",
    },
